...
public class MapaFarmacia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* mapFragment.getMapAsync(this);*/
        ...
        String[] placeTypeList = {"atm", "bank", "hospital", "movie_theater", "drugstore"};

        String[] placeNameList = {"ATM", "Bank", "Hospital", "Movie Theater", "Drugstore"};
        ...
        btFind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url="https://maps.googleapis.com/maps/api/place/nearbysearch/json"+
                        "?location="+currentLat+","+currenLong+"&radius=5000"+
                        "&types=hospital"+
                        "&sensor=true"+
                    ...
                    supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(@NonNull GoogleMap googleMap) {
                            ...
                            map.animateCamera(CameraUpdateFactory.newLatLngZoom(
                                    new LatLng(currentLat, currenLong), 10
                            ));
                        }
                    });
